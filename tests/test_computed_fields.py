...
class TestComputedFieldRegistry:
    ...
    def test_register_and_get(self):
        ...
        result = registry.get("app1", "dataset1")
    ...
    def test_get_unregistered_returns_none(self):
        ...
        result = registry.get("nonexistent", "dataset")
    ...
    def test_has_method(self):
        ...
        assert not registry.has("app1", "dataset1")

        registry.register("app1", "dataset1", [])

        assert registry.has("app1", "dataset1")
        assert not registry.has("app1", "dataset2")
    ...
    def test_unregister(self):
        ...
        result = registry.unregister("app1", "dataset1")
    ...
    def test_clear(self):
        ...
        assert not registry.has("app1", "dataset1")
        assert not registry.has("app2", "dataset2")
